...
func (m *MockClient) QueryNPlusOneCandidates(ctx context.Context, start, end time.Time, topN int) ([]model.NPlusOneCandidate, error) {
	m.logQuery(kql.BuildNPlusOneCandidateQuery(start, end, m.opts.Profile.Target, topN))
	return []model.NPlusOneCandidate{
		{
			Endpoint:              "GET /api/v1/products/recommendations",
			TotalRequests:         28500,
			AvgSQLCalls:           18.0,
